...
Document::setTitle(Lang::txt('COM_DRWHO') . ': ' . Lang::txt('COM_DRWHO_CHARACTERS') . ': ' . $this->character->get('name'));
	...
	<div id="content-header-extra">
		<p>
			<a class="icon-prev btn" href="<?php echo Route::url('index.php?option=' . $this->option . '&controller=' . $this->controller); ?>">
				<?php echo Lang::txt('COM_DRWHO_CHARACTERS'); ?>
			</a>
		</p>
	</div>
</header>
...
<section class="main section">
	<form class="section-inner" action="<?php echo Route::url('index.php?option=' . $this->option . '&controller=' . $this->controller); ?>" method="get">
		<h3><?php echo $this->escape($this->character->get('name')); ?></h3>
		<?php echo $this->character->bio('parsed'); ?>
	</form>
</section>